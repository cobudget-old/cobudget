_ = require('lodash')
Addresses = require('address-rfc2822').parse
isEmail = require('email-validator').validate
...
module.exports = ($scope, $modal, $modalInstance, $q, MembershipModel, MembershipsStore, group) ->
  ...
  $scope.submit = (addMembersForm) ->
    ...
    # validate addresses
    addresses = Addresses($scope.model.addresses)
    ...
    if not _.every(members, (m) -> isEmail(m.email))
      addMembersForm.addresses.$error.emails = true
      return
