...
/* @ngInject */
module.exports = function ($scope, $modal, authModel) {

  $scope.authModal = null;

  $scope.openModal = function (modal) {
    if ($scope.authModal) {
      $scope.authModal.dismiss();
    }

    $scope.authModal = $modal.open(modal);

    return $scope.authModal.result;
  };

  $scope.closeModal = function () {
    $scope.authModal.close()
  };
  ...
  authModel.on("notAuthenticated", $scope.openLogin);
  authModel.on("sessionTimeout", $scope.openLogin);
