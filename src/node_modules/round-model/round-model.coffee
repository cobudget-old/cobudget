  ...
  class RoundModel
    constructor: (data = {}) ->
      ...
      defineProperties @,
        ...
        myAllocationAmount:
          deps: ['myAllocationAmountCents']
          get: ->
            @myAllocationAmountCents / 100

        myAllocationLeftCents:
          deps: ['myAllocationAmountCents', 'myContributionsCents']
          get: ->
            @myAllocationAmountCents - @myContributionsCents

        myAllocationLeft:
          deps: ['myAllocationLeftCents']
          get: ->
