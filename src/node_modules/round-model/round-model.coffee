  ...
  class RoundModel
    constructor: (data = {}) ->
      ...
      myAllocation:
        get: ->
          ...
          (_.find @allocations, (allocation) ->
            allocation.user.id == currentUserId
      ...
      allocationsTotalCents:
        get: ->
          amountCents = _.pluck @allocations, "amountCents"
          _.reduce amountCents, (sum, num) -> sum + num

      myContributionsCents:
        get: ->
          amountCents = _.pluck @contributions, "amountCents"
          _.reduce amountCents, (sum, num) -> sum + num

      allocationsLeftCents:
        get: ->
          @myAllocation.amountCents - @myContributionsCents
