    ...
    Object.defineProperties scope.model,
      ...
      startContributing:
        value: ($event) ->
          ...
          $timeout ->
            ...
            # hack for firefox micro-blurring on above focus
            scope.model.hack = true
            debug("hack", scope.model.hack)
            $timeout ->
              debug("hack", scope.model.hack)
              scope.model.hack = false
            , 100
      ...
      saveContribution:
        value: (myContribution) ->
          ...
          # hack for firefox micro-blurring on initial focus
          debug("hack", scope.model.hack)
          return if scope.model.hack
