  ...
  <div class="bucket">
    ...
    <div class="progress">
      ...
      <div contribution-status="round.balanceStatus"
        ...
        <span class="sr-only">{{ Math.min(bucket.myContributionPercentage, 100 - bucket.groupContributionPercentage) }}% Complete</span>
      </div>
    ...
    <span contribution-status="round.balanceStatus" class="myContributionCents" style="float: left;">${{ bucket.myContribution.amount }}</span>
