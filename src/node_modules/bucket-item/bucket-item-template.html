  ...
  <div class="bucket item row" ng-class="{ selected: selected }">
    ...
    <div class="col-md-10 col-sm-9 col-xs-8">
      <div class="progress">
        ...
        <div contribution-status="round.balanceStatus" ng-class="{ inactive: model.readonly }"
      ...
      <div class="clearfix">
        <div class="equation">
          ...
          <span contribution-status="round.balanceStatus" class="myContribution" ng-class="{ inactive: model.readonly }">${{ bucket.myContribution.amount.toString() }}</span>
    ...
    <div class="col-md-2 col-sm-3 col-xs-4">
      <div class="contribution" ng-class="{ inactive: model.readonly, contributing: model.contributing, ready: model.inputStatus == 'ready', unsaved: model.inputStatus == 'unsaved', saving: model.inputStatus == 'saving', saved: model.inputStatus == 'saved'}" contribution-status="round.balanceStatus">
        ...
        <span ng-if="model.inputStatus == 'ready' && round.balanceStatus === 'success'" class="btn" tooltip="You have no money left to contribute.">Fund</span>
