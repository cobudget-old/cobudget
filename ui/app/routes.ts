...
// to the empty string
global.cobudgetApp.config(['$locationProvider', $locationProvider => $locationProvider.hashPrefix('')]);

global.cobudgetApp.config(function($stateProvider, $urlRouterProvider) {
  ...
  return $stateProvider
    ...
    .state('services', require('app/components/services-page/services-page.coffee'))
