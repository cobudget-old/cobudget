...
angular.module('xeditable').factory('editableController', ['$q', '$document', 'editableUtils', '$rootScope',
  ...
  function EditableController($scope, $attrs, $element, $parse, editableThemes, editableOptions, $rootScope, $compile, $q) {
    ...
    */
    ...
    self.save = function() {
      data = angular.copy(self.scope.$data)
      valueGetter.assign($scope.$parent, data);
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    'cobudget': {
      ...
      submitTpl:    '<button class="icon-checkmark-circle" type="submit"></button>',
      cancelTpl:    '<button class="icon-cancel-circle" type="button" ng-click="$form.$cancel()"></button>'
    },
